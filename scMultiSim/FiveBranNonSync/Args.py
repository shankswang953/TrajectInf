...
def get_args():
    ...
    parser.add_argument('--UnbalancedOT', type=bool, default=False, help='Unbalanced Optimal Transport')
    # General settings
    ...
    # Data parameters
    parser.add_argument('--data_path', type=str, default='../../data/scMultiSim/FiveBranch_scRNA_pca.npz', help='Path to data file')
    ...
    loss_group.add_argument('--density_coefficient', type=float, default=5000.0, help='Coefficient for density loss')
    ...
    loss_group.add_argument('--pdf_coefficient', type=float, default=5000.0, help='Coefficient for probability loss')
    ...
    loss_group.add_argument('--kl_coefficient', type=float, default=80000.0, help='Coefficient for KL divergence loss')
    ...
    loss_group.add_argument('--sync_loss', type=bool, default=False, help='Use synchronization ot loss')
    loss_group.add_argument('--sync_coefficient', type=float, default=10.0, help='Coefficient for synchronization ot loss')
    parser.add_argument('--sync_data_path', type=str, default='../../data/scMultiSim/FiveBranch_scATAC_pca.npz', help='Path to synchronization data file')
    
    loss_group.add_argument('--sync_mmd_loss', type=bool, default=True, help='Use synchronization mmd loss')
    loss_group.add_argument('--sync_mmd_coefficient', type=float, default=10000.0, help='Coefficient for synchronization mmd loss')
    ...
    loss_group.add_argument('--sync_pdf_coefficient', type=float, default=8000.0, help='Coefficient for synchronization pdf loss')
...
def get_notebook_args():
    ...
    # Data parameters
    parser.add_argument('--data_path', type=str, default='../../data/scMultiSim/FiveBranch_scRNA_pca.npz')
    parser.add_argument('--time_labels', type=str, nargs='+', default=['time1', 'time2', 'time3', 'time4'])# the last one is the support of the bump
    ...
    # Loss parameters
    loss_group = parser.add_argument_group('Loss Parameters')
    parser.add_argument('--sync_data_path', type=str, default='../../data/scMultiSim/FiveBranch_scATAC_pca.npz')
