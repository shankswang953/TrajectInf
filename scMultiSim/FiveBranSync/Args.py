...
def get_args():
    ...
    parser.add_argument('--UnbalancedOT', type=bool, default=False, help='Use unbalanced OT')
    # General settings
    ...
    loss_group.add_argument('--density_coefficient', type=float, default=1000.0, help='Coefficient for density loss')
    ...
    loss_group.add_argument('--kl_coefficient', type=float, default=40000.0, help='Coefficient for KL divergence loss')
    ...
    loss_group.add_argument('--sync_coefficient', type=float, default=20.0, help='Coefficient for synchronization ot loss')
    ...
    loss_group.add_argument('--sync_pdf_coefficient', type=float, default=500.0, help='Coefficient for synchronization pdf loss')
