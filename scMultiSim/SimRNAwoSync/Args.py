...
def get_args():
    ...
    parser.add_argument('--dt', type=float, default=0.1, help='Time step for density loss')
    ...
    loss_group.add_argument('--kl_coefficient', type=float, default=100000.0, help='Coefficient for KL divergence loss')
    ...
    loss_group.add_argument('--sync_mmd_coefficient', type=float, default=1.0, help='Coefficient for synchronization mmd loss')
    loss_group.add_argument('--sync_energy_coefficient', type=float, default=1.0, help='Coefficient for synchronization energy loss')
    ...
    loss_group.add_argument('--sync_pdf_coefficient', type=float, default=2000.0, help='Coefficient for synchronization pdf loss')
