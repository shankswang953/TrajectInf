...
primary_data = [data.to(device) for data in data_train] + [data.to(device) for data in data_support]
...
secondary_data = [data.to(device) for data in secondary_space] + [data.to(device) for data in secondary_support]
# record the number of samples in each group
